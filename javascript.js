mapboxgl.accessToken = 'pk.eyJ1IjoiYXVzdGlucnMxNiIsImEiOiJja2pseW1pbHQwazhzMnpvMDF2aXJ5bDI2In0.tzanjdRc4cLi1lIZNJgHeQ'
  ...
  map.on('click', 'libraries', function(f) {
   ...
   var distance = turf.distance(refLibrary, nearestHospital, {units: 'miles'});
      ...
      popup.setLngLat(refLibrary.geometry.coordinates)
          .setHTML('<b>' + refLibrary.properties.NAME + '</b><br>The nearest hospital is ' + nearestHospital.properties.NAME + ', located ' + distance.toFixed(2) + ' miles away, at ' + nearestHospital.properties.ADDRESS)
          .addTo(map);
});
